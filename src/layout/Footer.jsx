...
import { Award, Instagram, Linkedin, Star } from "lucide-react";
        ...
        <div className="grid gap-10 border-b border-slate-200 pb-12 md:grid-cols-4 md:gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-sm">
              ...
              <button type="button" onClick={() => scrollToSection("how-it-works")} className="block text-left text-slate-600 hover:text-blue-600">How It Works</button>
              <button type="button" onClick={() => scrollToSection("pricing")} className="block text-left text-slate-600 hover:text-blue-600">Pricing</button>
